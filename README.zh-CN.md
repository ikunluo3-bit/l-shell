...
[![在线能力总览](https://img.shields.io/badge/%E2%96%B6%20%E5%9C%A8%E7%BA%BF%E8%83%BD%E5%8A%9B%E6%80%BB%E8%A7%88-f0a848?style=for-the-badge)](https://ikunluo3-bit.github.io/l-shell-ios/)

**一个主题化的交互式展示**——页面内嵌活的终端、完整命令清单和架构,是最快了解 L Shell 的方式。<sub>(源文件在 [`docs/`](docs/))</sub>
...
**[→ 完整交互式展示](https://ikunluo3-bit.github.io/l-shell-ios/)**——页面内嵌活的终端、完整命令清单和架构,一个主题化的能力总览站。
